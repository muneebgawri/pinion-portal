...
namespace WeDevs\Wpuf\Pro\Admin\Appsero;

// bundled the updater with plugin.
// Because using it with composer might load another appsero SDK from different plugin
